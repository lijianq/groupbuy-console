                    ...
                    <a-col :span="4">
                        <div style="padding: 20px">
                            <div>
                                ...
                                <div style="color: #606266;font-size: 24px;padding: 10px 0">{{record.currentMonthCount}}</div>
                                <div>
                                <span :class="[record.compareMonthCount >= 0 ? 'color-success' : 'color-danger']" style="font-size: 14px">
                                    {{record.compareMonthCount >= 0 ? '+' + record.compareMonthCount + '%' : record.compareMonthCount + '%' }}
                                </span>
                            ...
                            <div style="margin-top: 20px;">
                                ...
                                <div style="color: #606266;font-size: 24px;padding: 10px 0">{{record.currentWeekCount}}</div>
                                <div>
                                <span :class="[record.compareWeekCount >= 0 ? 'color-success' : 'color-danger']" style="font-size: 14px">
                                    {{record.compareWeekCount >= 0 ? '+' + record.compareWeekCount + '%' : record.compareWeekCount + '%' }}
                                </span>
                    ...
                    <a-col :span="20">
                        <a-row class="label-date-picker">
                            <a-col :span="5" :offset="1">
                                <div style="color:#666666;font-size: 14px;font-weight:bold">近{{chartDuration}}日订单数量为：{{chartCountSum}}</div>
                            </a-col>
                            <a-col :span="2" :offset="5">
                                <a-button type="link" block @click="countSelToday">今日</a-button>
                            </a-col>
                            <a-col :span="2">
                                <a-button type="link" block @click="countSelWeek">本周</a-button>
                            </a-col>
                            <a-col :span="2">
                                <a-button type="link" block @click="countSelMonth">本月</a-button>
                            </a-col>
                            <a-col :span="7">
                                <a-range-picker 
                                    format="YYYY-MM-DD" 
                        ...
                        <a-row>
                            <a-col :span="24">
                                <div style="border-left:1px solid #DCDFE6">
                                    ...
                                    :settings="countChartSettings"></ve-line>
                                </div>
                            </a-col>
                        </a-row>
                    </a-col>
            ...
            <a-card style="margin-top:20px;" :headStyle="headStyle">
                ...
                <a-row>
                    <a-col :span="4">
                        <div style="padding: 20px">
                            <div style="margin-top: 20px;">
                                ...
                                <div style="color: #606266;font-size: 24px;padding: 10px 0">{{record.currentMonthSum}}</div>
                                <div>
                                <span :class="[record.compareMonthSum >= 0 ? 'color-success' : 'color-danger']" style="font-size: 14px">
                                    {{record.compareMonthSum >= 0 ? '+' + record.compareMonthSum + '%' : record.compareMonthSum + '%' }}
                                </span>
                                <span style="color: #C0C4CC;font-size: 14px">同比上月</span>
                                </div>
                            </div>
                            <div style="margin-top: 20px;">
                                ...
                                <div style="color: #606266;font-size: 24px;padding: 10px 0">{{record.currentWeekSum}}</div>
                                <div>
                                <span :class="[record.compareWeekSum >= 0 ? 'color-success' : 'color-danger']" style="font-size: 14px">
                                    {{record.compareWeekSum >= 0 ? '+' + record.compareWeekSum + '%' : record.compareWeekSum + '%' }}
                                </span>
                                <span style="color: #C0C4CC;font-size: 14px">同比上周</span>
                                </div>
                            </div>
                    ...
                    <a-col :span="20">
                        <a-row class="label-date-picker">
                            <a-col :span="5" :offset="1">
                                <div style="color:#666666;font-size: 12px;font-weight:bold">近{{chartDuration}}日订单金额为：{{chartAmountSum}}</div>
                            </a-col>
                            <a-col :span="2" :offset="5">

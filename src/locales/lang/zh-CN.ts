...
export default  class ZhCN {
    ...
    private static messages = {
        ...
        "account.register.baseinfo": "公司基本信息",
        "account.register.license": "公司营业执照",
        "account.register.finish": "完成注册",
        "account.register.baseinfo.companyname": "公司名称",
        "account.register.baseinfo.companyname.required": "请输入公司名称",
        "account.register.baseinfo.companyname.max": "请输入少于100个字符",
        "account.register.baseinfo.companyindustry": "所属行业",
        "account.register.baseinfo.companyindustry.required": "请选择所属行业",
        "account.register.baseinfo.companycontact": "公司联系人",
        "account.register.baseinfo.companycontact.required": "请输入公司联系人",
        "account.register.baseinfo.companycontact.max": "请输入少于30个字符",
        "account.register.baseinfo.companyemail": "公司邮件",
        "account.register.baseinfo.companyemail.required": "请输入公司邮件",
        "account.register.baseinfo.companyemail.invalid": "请输入有效的邮件地址",
        "account.register.baseinfo.companyemail.max": "请输入少于100个字符",
        "account.register.baseinfo.companyphone": "公司电话",
        "account.register.baseinfo.companyphone.required": "请输入公司电话",
        "account.register.baseinfo.companyphone.invalid": "请输入有效的电话",
        "account.register.baseinfo.companyphone.max": "请输入少于20个字符",
        "account.register.baseinfo.companyaddress": "公司地址",
        "account.register.baseinfo.companyaddress.required": "请输入公司地址",
        "account.register.baseinfo.companyaddress.max": "请输入少于200个字符",
        "account.register.baseinfo.next": "下一步",
        "account.register.license.companylogo": "公司标志",
        "account.register.license.companylogo.upload": "点击上传公司标志",
        "account.register.back": "返回登录",
        "account.register.license.companylicenseno": "营业执照编号",
        "account.register.license.companylicenseno.required": "请输入营业执照编号",
        "account.register.license.companylicenseno.invlaid": "请输入有效的营业执照编号",
        "account.register.license.companylicense": "营业执照",
        "account.register.license.companylicense.upload": "点击或拖动文件上传营业执照副本",
        "account.register.license.companylicense.required": "请上传营业执照",

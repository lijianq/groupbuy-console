...
export default class ZhCN {
    ...
    static messages = {
        ...
        "weight.required": "请输入正确的重量",
        "common.package.unit": "件",
        "common.money.unit": "元",
        "common.weight.unit": "公斤",
        // common error
        "error.400": "无效请求",
        "error.401": "未授权访问",
        "error.403": "禁止访问",
        ...
        "operation.freight.type.0": "按件计费",
        "operation.freight.type.1": "按重计费",
        "operation.freight.type.required": "请选择计费方式",
        "operation.freight.rule": "计费规则",
        ...
        "operation.freight.unit": "件内",
        "operation.freight.weight": "公斤内",
        "operation.freight.increase": "每增加",
        "operation.freight.fee.increase": "增加",
        "operation.freight.region.rule": "特定地区规则",
        "operation.freight.region.add": "添加地区规则",
        "operation.freight.region": "地区",
        "operation.freight.region.required": "请选择地区"
    }
